...
class FoodNetworkRecipeImporter extends RecipeImporter {
    ...
    function __construct() {
        $this->_siteName_STR = "Food Network";
        
        $page = new Page();
        $this->_siteLogoUrl_STR = $page->getImage("recipe-importers/food-network.png");
    }

    public function getRecipe() {
        $recipe = new Recipe("New Recipe - Food Network");
