...
class RelishRecipeImporter extends RecipeImporter {
    ...
    function __construct() {
        $this->_siteName_STR = "Relish";
        
        $page = new Page();
        $this->_siteLogoUrl_STR = $page->getImage("recipe-importers/relish.png");
    }

    public function getRecipe() {
        $recipe = new Recipe("New Recipe - Relish");
