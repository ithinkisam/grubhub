...
class WomansDayRecipeImporter extends RecipeImporter {
    ...
    function __construct() {
        $this->_siteName_STR = "Woman's Day";
        
        $page = new Page();
        $this->_siteLogoUrl_STR = $page->getImage("recipe-importers/womans-day.png");
    }

    public function getRecipe() {
        $recipe = new Recipe("New Recipe - Womans Day");
