...
class GenericRecipeImporter extends RecipeImporter {
    ...
    function __construct() {
        $this->_siteName_STR = "Unknown";
        
        $page = new Page();
        $this->_siteLogoUrl_STR = $page->getImage("recipe-importers/generic.png");
    }

    public function getRecipe() {
        $recipe = new Recipe("New Recipe - Generic");
