...
class AllRecipesRecipeImporter extends RecipeImporter {
    ...
    function __construct() {
        $this->_siteName_STR = "All Recipes";
        
        $page = new Page();
        $this->_siteLogoUrl_STR = $page->getImage("recipe-importers/all-recipes.png");
    }
    
    public function getRecipe() {
        $recipe = new Recipe("New Recipe - All Recipes");
